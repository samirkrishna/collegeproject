...
class IT2F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.it2f,container,false)
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable2I::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus2I::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance2I::class.java))
        })
