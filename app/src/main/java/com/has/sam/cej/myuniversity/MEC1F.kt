    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable1M::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus1M::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance1M::class.java))
        })
