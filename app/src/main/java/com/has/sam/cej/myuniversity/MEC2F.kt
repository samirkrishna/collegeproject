    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable2M::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus2M::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance2M::class.java))
        })
