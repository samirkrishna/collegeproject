...
class IT3F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.it3f,container,false)
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable3I::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus3I::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance3I::class.java))
        })
