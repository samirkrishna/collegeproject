...
class CSE1F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.cse1f,container,false)
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable1C::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus1C::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance1C::class.java))
        })
        return v
