...
class EEE4F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.eee4f,container,false)
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable4E::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus4ee::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance4EE::class.java))
        })
        return v
