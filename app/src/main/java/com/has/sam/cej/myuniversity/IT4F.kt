...
class IT4F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.it4f,container,false)
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable4I::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus4I::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance4I::class.java))
        })
