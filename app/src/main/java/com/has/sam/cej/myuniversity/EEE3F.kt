...
class EEE3F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.eee3f,container,false)
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable3EE::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus3ee::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance3EE::class.java))
        })
