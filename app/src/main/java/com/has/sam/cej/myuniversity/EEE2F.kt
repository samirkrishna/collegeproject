...
class EEE2F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.eee2f,container,false)
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable2EE::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus2ee::class.java))
        })
