    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable4M::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus4M::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance4M::class.java))
        })
