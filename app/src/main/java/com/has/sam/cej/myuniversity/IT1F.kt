...
class IT1F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.it1f,container,false)
        ...
        ttc1?.setOnClickListener({
           /* var fManager=fragmentManager
            ...
            startActivity(Intent(activity,TimeTable1I::class.java))
        })
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus1I::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance1I::class.java))
        })
