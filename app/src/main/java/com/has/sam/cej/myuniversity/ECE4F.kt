...
class ECE4F :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var v=inflater.inflate(R.layout.ece4f,container,false)
        ...
        sc1?.setOnClickListener({
            startActivity(Intent(activity,Syllabus4e::class.java))
        })
        ac1?.setOnClickListener({
            startActivity(Intent(activity,Attendance4E::class.java))
        })
